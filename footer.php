	...
	<div class="container">
		<div class="row">
			<div class="items text-center">
				<ul>
					<li><img src="images/phone.png" alt="phone"> +995 555-12-65-11</li>
					<li><img src="images/mail.png" alt="mail"> info@LinuxServ.Ge</li>
					<li><img src="images/supp.png" alt="supp"> ონლაინ დახმარება</li>
				</ul>
			</div>
		</div>
	</div>
...
<section class="web-footer">
		...
		<div class="row">
			<div class="col-lg-4 col-sm-6">
				<div class="footer-widget">
					<div class="header text-center "><h2>LinuxServ.Ge</h2></div>
					<div class="footer-about">
						<p>
							დაგვიკავშირდით facebook-ის ან twitter-ის მეშვეობით.
							ასევე შეგიძლიათ ეწვიოთ ჩვენს youtube არხს და ნახოთ
							ჩვენს მიერ გაკეთებუ-ლი გაიდები. თუ ხართ დამწყები ან
							გსურთ რაიმეს სწავლა ეს სწორედ ისაა რაც თქვენ გჭირდებათ.
						</p>
					</div>
					<div class="social-links">
						<ul>
							...
							<li><a href="#"><i class="class="fas fa-rss""></i></a></li>
						</ul>
	...
	<div class="bottom-footer">
		<div class="container">
			<div class="row">
				<div class="rights col-md-5">
					<h2>© 2018 LinuxServ.Ge ყველა უფლება დაცულია</h2>
				</div>
				<div class="footer-navbar col-md-7">
					<ul>
